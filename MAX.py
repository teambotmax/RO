                        ...
                        if cmd == "unsend off":
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                if wait["talkban"] == True: md+="┃🤖┃ ✔️「 Talkban 」\n"
                                else: md+="┃🤖┃ ❌「 Talkban 」\n"
                                if wait["Mentionkick"] == True: md+="┃🤖┃ ✔️「 Notag 」\n"
                                else: md+="┃🤖┃ ❌「 Notag 」\n"
                                if wait["detectMention"] == True: md+="┃🤖┃ ✔️「 Respon 」\n"
                                else: md+="┃🤖┃ ❌「 Respon 」\n"
                                if wait["Mentiongift"] == True: md+="┃🤖┃ ✔️「 Respongift 」\n"
                                else: md+="┃🤖┃ ❌「 Respongift 」\n"                                
                                ...
                                if msg.to in welcome: md+="┃🤖┃ ✔️「 Welcome 」\n"
                                else: md+="┃🤖┃ ❌「 Welcome 」\n"
                                if wait["autoLeave"] == True: md+="┃🤖┃ ✔️「 Autoleave 」\n"
                                else: md+="┃🤖┃ ❌「 Autoleave 」\n"
                                if msg.to in protectqr: md+="┃🤖┃ ✔️「 Protecturl 」\n"
                                else: md+="┃🤖┃ ❌「 Protecturl 」\n"
                                if msg.to in protectjoin: md+="┃🤖┃ ✔️「 Protectjoin 」\n"
                                else: md+="┃🤖┃ ❌「 Protectjoin 」\n"
                                if msg.to in protectkick: md+="┃🤖┃ ✔️「 Protectkick 」\n"
                                else: md+="┃🤖┃ ❌「 Protectkick 」\n"
                                if msg.to in protectcancel: md+="┃🤖┃ ✔️「 Protectcancel 」\n"
                                else: md+="┃🤖┃ ❌「 Protectcancel 」\n"
                                if msg.to in protectinvite: md+="┃🤖┃ ✔️「 Protectinvite 」\n"
